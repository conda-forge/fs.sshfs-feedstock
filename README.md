About fs.sshfs-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/fs.sshfs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3885&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/fs.sshfs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `fs.sshfs` can be installed with `conda`:
...
```
mamba install fs.sshfs
```

It is possible to list all of the versions of `fs.sshfs` available on your platform with `conda`:
...
```
mamba search fs.sshfs --channel conda-forge
```
...
mamba repoquery search fs.sshfs --channel conda-forge

# List packages depending on `fs.sshfs`:
mamba repoquery whoneeds fs.sshfs --channel conda-forge

# List dependencies of `fs.sshfs`:
mamba repoquery depends fs.sshfs --channel conda-forge
```
